...
constexpr float teganganPh7 = 2.6;
constexpr float teganganPh4 = 3.1;
constexpr float phStep = (teganganPh4 - teganganPh7) / 3;

//Turbidity
#define TURBIDITY_SENSOR_PIN 14
constexpr int MAX_VOLTAGE = 4.5;
constexpr int MAX_TURBIDITY = 100;
...
constexpr float calibrationFactor = 8.51;
